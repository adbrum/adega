      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-sm-6 col-lg-4">
            <div className="single_blog_item">
              <div className="single_blog_image">
                <img src="/assets/image/food_item/cozido_grao.jpg" alt="" />
              </div>
              <div className="single_blog_text">
                ...
                {/* <a href="#" className="btn_3">Read More <img src="/assets/image/icon/left_2.svg" alt="" /></a> */}
              </div>
            </div>
          </div>
          <div className="col-sm-6 col-lg-4">
            <div className="single_blog_item">
              <div className="single_blog_image">
                <img src="/assets/image/food_item/acorda.jpg" alt="" />
              </div>
              <div className="single_blog_text">
          ...
          <div className="col-sm-6 col-lg-4">
            <div className="single_blog_item">
              <div className="single_blog_image">
                <img src="/assets/image/food_item/migas.jpg" alt="" />
              </div>
              <div className="single_blog_text">
          ...
          {/* <div className="col-sm-6 col-lg-4 d-none d-sm-block d-lg-none"> <div className="single_blog_item"> <div className="single_blog_image"> <img src="/assets/image/food_item/food_item_1.png" alt="" /> </div> <div className="single_blog_text"> <h3>Cremy Noodles</h3> <p> Was brean shed moveth day yielding tree yielding day were female and </p> <a href="#" className="btn_3" >Read More <img src="/assets/image/icon/left_2.svg" alt="" /></a> </div> </div> </div> */}
        </div>
      </div>
    </section>
  );
